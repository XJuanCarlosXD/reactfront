    ...
    <>
      <motion.div
        ...
        <div className="main-header">
          <Link className="menu-link-main" href="#">All Apps</Link>
          <div className="header-menu">
            <Link className="main-header-link is-active" href="#">Desktop</Link>
            <Link className="main-header-link" href="#">Mobile</Link>
        ...
        <div className="content-wrapper">
          <div className="content-wrapper-header">
            <div className="content-wrapper-context">
              ...
              <div className="content-text">Grab yourself 10 free images from Adobe Stock in Link 30-day free trial plan and find perfect image, that will help you with your new project.</div>
                ...
                <div className="button-wrapper">
                  ...
                  <div className="menu">
                    <button className="dropdown">
                      <ul>
                        <li><Link href="#">Go to Discover</Link></li>
                        <li><Link href="#">Learn more</Link></li>
                        <li><Link href="#">Uninstall</Link></li>
                      </ul>
                    </button>
                  </div>
                </div>
              ...
              <li className="adobe-product">
                ...
                <div className="button-wrapper">
                  ...
                  <div className="pop-up">
                    ...
                    <div className="pop-up__subtitle">Adjust your selections for advanced options as desired before continuing. <Link href="#">Learn more</Link></div>
